...
const c = {
  ...
  cellToday:  { background: 'var(--surface2)', borderColor: '#7C3AED', boxShadow: '0 0 0 2px rgba(124,58,237,.12)' },
  outsideCell:{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: 34, fontSize: 11, color: 'var(--text-light)', opacity: 0.25 },
  dayNum:     { fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 14, fontWeight: 700, lineHeight: 1 },
